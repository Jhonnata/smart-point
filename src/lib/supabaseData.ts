...
function settingsRowFromData(userId: string, settings: Settings) {
  return {
    ...
    pollinations_model: settings.pollinationsModel ?? null,
...
function settingsFromRow(row: any): Settings {
  return {
    ...
    pollinationsModel: row?.pollinations_model ?? DEFAULT_SETTINGS.pollinationsModel,
    geminiApiKey: row?.gemini_api_key ?? '',
    geminiModel: row?.gemini_model ?? DEFAULT_SETTINGS.geminiModel,
    openaiApiKey: row?.openai_api_key ?? '',
    openaiModel: row?.openai_model ?? '',
    llamaindexApiKey: '',
    llamaindexTier: DEFAULT_SETTINGS.llamaindexTier,
